...
class selectUserAddressViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        let subView = UIView(frame: CGRect(x: 0, y: 70, width: self.view.frame.size.width, height: 45))
...
//        print(appDelegate.oldLongitude)
        ...
        let appendString = place.name + place.formattedAddress!
        
        delegate?.callbackWitAddress(strAddress: appendString, strAddressType: addressType)
